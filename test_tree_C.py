...
tree1.set_epsilon(1.5)
root_1 = tree1.root
root_1.verbose = 1
root_1.expand_to_children()
root_1.aggregator.interval_decay_rate = 0.88
root_1.train(epoch=30, init_lr=0.008, lambda_1=0.06, lambda_2=0.06, trans_delay=0.0,
             fake_foreign=False, adam=True, adaptive_c=False)
root_1.history.plot('c=grad_max')

root_1.reset()
tree1.set_grad_max(0.6)
root_1.train(epoch=30, init_lr=0.008, lambda_1=0.06, lambda_2=0.06, trans_delay=0.0,
             fake_foreign=False, adam=True, adaptive_c=True)
root_1.history.plot('c-adaptive')
